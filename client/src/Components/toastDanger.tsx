...
const Toast: React.FC<ToastProps> = ({ message, type = "danger", onClose }) => {
  return (
    <div
      id="toast-danger"
      ...
      role="alert"
    >
      <div className="inline-flex items-center justify-center shrink-0 w-8 h-8 text-red-500 bg-red-100 rounded-full dark:bg-red-800 dark:text-red-200">
        <svg
          className="w-5 h-5"
          aria-hidden="true"
